...
<head>
    ...
    <title>Login | B.M.I.S.</title>
		<!-- Favicon -->
        <link rel="shortcut icon" type="image/x-icon" href="{{ URL::to('images/images.jfif') }}">
		<!-- Bootstrap CSS -->
            ...
            <div class="account-content">
                ...
                <div class="container">
                    ...
                    <div class="account-logo">
                        <a><img src="{{ URL::to('images/images.jfif') }}" alt="Seal"></a>
                        <br/>
                        <h1><b></b>Baranggay Bolocaon</b></h1> <h5>Managment Information System</h5>
                    </div>
                    {{-- message --}}
                    {!! Toastr::message() !!}
                    <!-- /Account Logo -->
