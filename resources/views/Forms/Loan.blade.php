...
<div class="d-flex flex-wrap justify-content-center" style="border-bottom: 1px solid red; border-top: 0;">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="text-center">
                                                <h5 class=" fw-bold mb-5">FOR LOAN REQUEST</h5>
                                            </div>
                                        ...
                                        <p class="fw-bold">TO WHOM IT MAY CONCERN:</p>
                                            ...
                                            <span class="fw-bold" >{{ $item->barangay }} Barangay Bolocaon, Kitaotao, Bukidnon</span> is the owner of <br>
                                                    Please Specify:<br>
                                                            1. {{ request('businessName') }}<br>
                                                            2. {{ request('businessSpecifications') }}</p>
