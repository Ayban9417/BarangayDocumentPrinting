@extends('layouts.app')
@section('title', $barangay . ' List | B.M.I.S.')
        ...
        <div class="card card-primary card-outline card-outline-tabs">
            ...
            <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                    <li class="pt-2 px-3"><h3 class="card-title">Resident List</h3></li>
                    @foreach ($bgry as $item)
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('Residents/'.$item->barangay.'*') ? 'active' : null }}"  href="/Residents/{{$item->barangay}}" role="tab">{{$item->barangay}}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
            ...
            <!-- card-body -->
            <div class="card-body">
                <a class="btn btn-warning full-right btn-xs mb-3" href="{{route('barangays.index')}}"><i class='fa fa-arrow-left'></i> Back</a>
                <a class="btn btn-warning full-right btn-xs mb-3" href="{{ route('excel.export.brgy', $barangay) }}"><i class='fa fa-download'></i> Export Excel</a>
