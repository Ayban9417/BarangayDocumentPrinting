@extends('layouts.app')
@section('title','Edit Resident Details | B.M.I.S.')
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <img id="cover_image" src="/storage/images/{{$resident->image}}"
                                                        style="
                                                        display: block;
                                                        margin-left: auto;
                                                        margin-right: auto;
                                                ...
                                                <!-- /.User Image -->
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="date" id="birth_date" name="birth_date" class="form-control" max="{{ date('Y-m-d') }}" value="{{ $resident->birth_date }}">
                                                            </div>
                                                        </div>
                                                        <br/>
                                                        <div class="row">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="row mb-4">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <input type="text" id="occupation" name="occupation"  class="form-control" value="{{$resident->occupation}}">
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <small>BirthPlace</small>
                                                                            <input type="text" id="birthplace" name="birthplace"  class="form-control" value="{{$resident->birthplace}}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
