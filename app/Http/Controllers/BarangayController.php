...
class BarangayController extends Controller
{
    ...
    {
        //
        $barangay_update = Barangay::find($id);
        $barangay_update->barangay = strtoupper(request('barangay'));
        $barangay_update->municipality = strtoupper(request('municipality'));
        $barangay_update->province = strtoupper(request('province'));
        $barangay_update->postal_id = strtoupper(request('postal_id'));
        $barangay_update->save();
